...
var playingCard = {
    1: {
        ...
        back: {
            ...
            fact: "Andorra is the world’s only co-principality, both President of France and the Bishop of Urgell.",
            imagePath: "images/andorra-300x210.png"
        }
    },
    2: {
        flipped: false,
    ...
    3: {
        ...
        back: {
            ...
            country: "Moldova",
            capital: "Chișinău",
            fact: "Between 2009 and 2012, the country had no president.",
            imagePath: "images/moldova-300x150.png"
        }
    },
    4: {
        flipped: false,
    ...
    5: {
        ...
        back: {
            ...
            country: "India",
            capital: "New Delhi",
            fact: "Second largest population in the world.",
            imagePath: "images/india-300x200.png"
        }
    },
    6: {
        flipped: false,
    ...
    7: {
        ...
        back: {
            ...
            country: "Niger",
            capital: "Niamey",
            fact: "Has been inhabited for over 50,000 years.",
            imagePath: "images/niger-300x257.png"
        }
    },
    8: {
        flipped: false,
    ...
    9: {
        ...
        back: {
            ...
            fact: "Is home to over 30 official languages.",
            imagePath: "images/bolivia-300x204.png"
        }
    },
    10: {
        flipped: false,
    ...
    11: {
        ...
        back: {
            ...
            country: "Ghana",
            capital: "Accra",
            fact: "The name “Ghana” means “warrior king” in the Soninke language.",
            imagePath: "images/ghana-300x200.png"
        }
    },
    12: {
        flipped: false,
    ...
    13: {
        ...
        back: {
            ...
            fact: "Voodoo is an officially recognized religion in Haiti.",
            imagePath: "images/haiti-300x180.png"
        }
    },
    14: {
        flipped: false,
    ...
    15: {
        ...
        back: {
            ...
            capital: "Vaduz",
            fact: "There’s only one billionaire in Liechtenstein, but he’s worth 50% of the country’s GDP.",
            imagePath: "images/Liechtenstein-300x180.png"
        }
    },
    16: {
        flipped: false,
