...
var playingCard = {
    ...
    3: {
        ...
        back: {
            ...
            country: "New Zealand",
            capital: "Wellington",
            fact: "There Are Five Sheep for Every Resident in New Zealand.",
            imagePath: "images/newZealand-300x150.png"
        }
    },
    4: {
        flipped: false,
    ...
    5: {
        ...
        back: {
            ...
            country: "Chad",
            capital: "N'Djamena",
            fact: "The Sahara Desert covers much of northern Chad and occupies roughly 1/3rd of the country’s total area.",
            imagePath: "images/chad-300x200.png"
        }
    },
    6: {
        flipped: false,
    ...
    7: {
        ...
        back: {
            ...
            country: "Romania",
            capital: "Bucharest",
            fact: "The name “Romania” comes from the Latin word “Romanus” which means “citizen of the Roman Empire.",
    ...
    9: {
        ...
        back: {
            ...
            country: "Guinea",
            capital: "Conakry",
            fact: "Chimpanzees discovered how to use tools in Guinea.",
            imagePath: "images/guinea-300x200.png"
        }
    },
    10: {
        flipped: false,
    ...
    11: {
        ...
        back: {
            ...
            country: "Mali",
            capital: "Bamako",
            fact: "Home to Mansa Musa, history's richest man with a $400 billion fortune in today's money.",
            imagePath: "images/mali-300x200.png"
        }
    },
    12: {
        flipped: false,
    ...
    13: {
        ...
        back: {
            ...
            country: "Ireland",
            capital: "Dublin",
            fact: "Halloween was invented in Ireland.",
            imagePath: "images/ireland-300x150.png"
        }
    },
    14: {
        flipped: false,
    ...
    15: {
        ...
        back: {
            ...
            fact: "It is the world’s largest cocoa producer with over 30% of the world's total.",
            imagePath: "images/ivoryCoast-300x200.png"
        }
    },
    16: {
        flipped: false,
