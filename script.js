...
var playingCard = {
    1: {
        ...
        back: {
            ...
            country: "Norway",
            capital: "Oslo",
            fact: "Europe's biggest herd of wild reindeer lives here.",
            imagePath: "images/norway-300x218.png"
        }
    },
    2: {
        flipped: false,
    ...
    3: {
        ...
        back: {
            ...
            country: "Iceland",
            capital: "Reykjavík",
            fact: "Many Icelanders believe in elves.",
    ...
    5: {
        ...
        back: {
            ...
            country: "Kenya",
            capital: "Nairobi",
            fact: "Has 50 national parks and reserves.",
            imagePath: "images/kenya-300x200.png"
        }
    },
    6: {
        flipped: false,
    ...
    7: {
        ...
        back: {
            ...
            country: "South Sudan",
            capital: "Juba",
            fact: "South Sudan is landlocked.",
            imagePath: "images/southSudan-300x150.png"
        }
    },
    8: {
        flipped: false,
    ...
    9: {
        ...
        back: {
            ...
            country: "Italy",
            capital: "Rome",
            fact: "13 of Shakespeare's 38 plays are set in Italy.",
            imagePath: "images/italy-300x200.png"
        }
    },
    10: {
        flipped: false,
    ...
    11: {
        ...
        back: {
            ...
            country: "Mexico",
            capital: "Mexico City",
            fact: "Is home to more Spanish speakers than any other country in the world.",
            imagePath: "images/mexico-300x171.png"
        }
    },
    12: {
        flipped: false,
    ...
    13: {
        ...
        back: {
            ...
            country: "Peru",
            capital: "Lima",
            fact: "The Amazon River begins in Peru.",
            imagePath: "images/peru-300x200.png"
        }
    },
    14: {
        flipped: false,
    ...
    15: {
        ...
        back: {
            ...
            country: "Canada",
            capital: "Ottawa",
            fact: "It has 2 official languages, English and French.",
            imagePath: "images/canada-flag-300x150.png"
        }
    },
    16: {
        flipped: false,
