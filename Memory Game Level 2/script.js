...
var playingCard = {
    1: {
        ...
        back: {
            ...
            country: "Columbia",
            capital: "Bogotá",
            fact: "Is the only country in South America that has coastlines on both the Pacific Ocean and the Caribbean Sea.",
            imagePath: "images/columbia-300x200.png"
        }
    },
    2: {
        flipped: false,
    ...
    3: {
        ...
        back: {
            ...
            country: "Venezuela",
            capital: "Caracas",
            fact: "It is home to the world’s highest waterfall at a height of 3,211 ft and a drop of 2,648ft.",
            imagePath: "images/venezuela-300x200.png"
        }
    },
    4: {
        flipped: false,
    ...
    5: {
        ...
        back: {
            ...
            country: "Ecuador",
            capital: "Quito",
            fact: "Was the first country in the world to recognize the rights of nature.",
            imagePath: "images/ecuador-300x200.png"
        }
    },
    6: {
        flipped: false,
    ...
    7: {
        ...
        back: {
            ...
            fact: "The American flag has had 27 versions.",
            imagePath: "images/US.png"
        }
    },
    8: {
        flipped: false,
    ...
    9: {
        ...
        back: {
            ...
            fact: "The flag was a winning design in a competition by a 29-year old architect.",
            imagePath: "images/malaysia-300x150.png"
        }
    },
    10: {
        flipped: false,
    ...
    11: {
        ...
        back: {
            ...
            country: "Liberia",
            capital: "Monrovia",
            fact: "Liberia has one of the world’s youngest populations with a median age of 18.",
            imagePath: "images/liberia-300x158.png"
        }
    },
    12: {
        flipped: false,
    ...
    13: {
        ...
        back: {
            ...
            country: "Hungary",
            capital: "Budapest",
            fact: "It is one of the oldest countries in Europe and was founded in 895.",
            imagePath: "images/hungary-300x150.png"
        }
    },
    14: {
        flipped: false,
    ...
    15: {
        ...
        back: {
            ...
            country: "Tajikistan",
            capital: "Dushanbe",
            fact: "It was at the heart of the Silk Road.",
            imagePath: "images/Tajikstan-300x150.png"
        }
    },
    16: {
        flipped: false,
